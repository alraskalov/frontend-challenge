# Ссылка на проект: [Кошачий пинтерест](https://frontend-challenge-blush.vercel.app/)
...
- При клике на карточку с котиком, открывается попап с полным изображением котика
